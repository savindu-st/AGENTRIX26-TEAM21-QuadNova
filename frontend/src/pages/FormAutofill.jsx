...
export default function FormAutofill() {
  const { citizenData, caseId, updateCitizenData } = useCitizenCase();
  ...
  const handleDownload = () => {
    ...
    const fileContent = `FORM 102-B: APPLICATION FOR TREE FELLING PERMIT\n\n` +
      ...
      `Reason for Request: ${formData.serviceNeed}\n\n` +
    ...
    link.href = url;
    link.download = `PreFilled_Form_102B_${caseId}.txt`;
